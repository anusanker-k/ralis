...
sys.path.append('/content/ralis/model')
...
from query_network import QueryNetworkDQN
from fpn import FPN50
from fpn_bayesian import FPN50_bayesian
from final_utils import get_logfile
